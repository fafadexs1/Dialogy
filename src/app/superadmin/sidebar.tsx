...
import { Bell, Home, LineChart, Package, Package2, ShoppingCart, Users, CreditCard, HardDrive, FileText } from "lucide-react";
...
const navItems = [
    ...
    { href: '/superadmin/plans', label: 'Planos', icon: FileText },
