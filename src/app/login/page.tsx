      ...
      <main className="w-full max-w-6xl grid md:grid-cols-2 shadow-2xl rounded-3xl overflow-hidden">
        ...
        <div className="bg-[#007BFF] text-white p-8 sm:p-12 flex flex-col justify-between relative">
          ...
          <div className="z-10">
            ...
            <h2 className="text-4xl font-bold leading-tight drop-shadow-md">Acesse sua conta para continuar</h2>
            <p className="text-lg text-white/80 mt-2 max-w-sm">Conecte-se com seus clientes de forma inteligente e automatizada.</p>
          </div>
